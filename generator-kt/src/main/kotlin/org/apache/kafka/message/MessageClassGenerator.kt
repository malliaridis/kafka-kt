...
interface MessageClassGenerator {

    /**
     * The short name of the converter class we are generating. For example,
     * `FetchRequestDataJsonConverter.kt`.
     */
    fun outputName(spec: MessageSpec): String
    ...
    fun generateAndWrite(spec: MessageSpec, writer: BufferedWriter)
}
