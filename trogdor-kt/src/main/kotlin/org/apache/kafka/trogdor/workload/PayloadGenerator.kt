 ...
 *
 * The array generated at a given position should be the same no matter how many times generate() is invoked.
 * PayloadGenerator instances should be immutable and thread-safe.
 */
...
interface PayloadGenerator {
     ...
     */
    fun generate(position: Long): ByteArray?
}
