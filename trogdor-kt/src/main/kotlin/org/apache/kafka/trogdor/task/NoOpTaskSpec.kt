 ...
 */
class NoOpTaskSpec @JsonCreator constructor(
    @JsonProperty("startMs") startMs: Long,
    @JsonProperty("durationMs") durationMs: Long,
) : TaskSpec(startMs, durationMs) {

    override fun newController(id: String?): TaskController = NoOpTaskController()

    override fun newTaskWorker(id: String): TaskWorker = NoOpTaskWorker(id)
}
