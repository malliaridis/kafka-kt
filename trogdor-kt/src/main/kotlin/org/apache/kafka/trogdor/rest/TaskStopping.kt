 ...
 *
 * @property startedMs The time on the agent when the task was received.
 */
class TaskStopping @JsonCreator constructor(
    ...
    override fun stateType(): TaskStateType = TaskStateType.STOPPING
}
