...
class TypeTest {
    ...
    fun testRecordsSerde() {
        ...
        val buffer = ByteBuffer.allocate(Type.RECORDS.sizeOf(records))
    ...
    @Test
    fun testEmptyCompactRecordsSerde() {
        val buffer = ByteBuffer.allocate(4)
    ...
    @Test
    fun testNullCompactRecordsSerde() {
        val buffer = ByteBuffer.allocate(4)
    ...
    fun testCompactRecordsSerde() {
        ...
        val buffer = ByteBuffer.allocate(Type.COMPACT_RECORDS.sizeOf(records))
