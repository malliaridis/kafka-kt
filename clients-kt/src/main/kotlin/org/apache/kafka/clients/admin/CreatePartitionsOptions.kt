...
/**
 * Options for [Admin.createPartitions].
 *
 * The API of this class is evolving, see [Admin] for details.
 */
@Evolving
class CreatePartitionsOptions : AbstractOptions<CreatePartitionsOptions>() {
    ...
    fun validateOnly(validateOnly: Boolean): CreatePartitionsOptions {
     ...
     */
    @Deprecated("User property instead")
    fun retryOnQuotaViolation(retryOnQuotaViolation: Boolean): CreatePartitionsOptions {
