...
/**
 * Options for [Admin.describeTopics].
 *
 * The API of this class is evolving, see [Admin] for details.
 */
@Evolving
class DescribeTopicsOptions : AbstractOptions<DescribeTopicsOptions>() {
    ...
    fun timeoutMs(timeoutMs: Int?): DescribeTopicsOptions {
        this.timeoutMs = timeoutMs
        return this
    }

    @Deprecated("User property instead")
    fun includeAuthorizedOperations(includeAuthorizedOperations: Boolean): DescribeTopicsOptions {
