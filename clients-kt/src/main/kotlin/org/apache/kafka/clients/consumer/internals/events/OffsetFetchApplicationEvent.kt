...
class OffsetFetchApplicationEvent(
    ...
    fun future(): CompletableFuture<Map<TopicPartition, OffsetAndMetadata>> = future

    @Deprecated(
        message = "Use property instead",
        replaceWith = ReplaceWith("partitions"),
    )
    fun partitions(): Set<TopicPartition> = partitions

    override fun toString(): String = "OffsetFetchApplicationEvent{future=$future, partitions=$partitions}"
}
