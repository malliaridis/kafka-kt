...
/**
 * Options for [Admin.deleteTopics].
 *
 * The API of this class is evolving, see [Admin] for details.
 */
@Evolving
class DeleteTopicsOptions : AbstractOptions<DeleteTopicsOptions?>() {
    ...
    fun timeoutMs(timeoutMs: Int?): DeleteTopicsOptions {
    ...
    fun retryOnQuotaViolation(retryOnQuotaViolation: Boolean): DeleteTopicsOptions {
