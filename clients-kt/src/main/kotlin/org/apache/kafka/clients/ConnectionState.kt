 ...
 * CHECKING_API_VERSIONS: connection has been established and api versions check is in progress.
...
enum class ConnectionState {
    ...
    val isDisconnected: Boolean
        get() = this == AUTHENTICATION_FAILED || this == DISCONNECTED

    val isConnected: Boolean
        get() = this == CHECKING_API_VERSIONS || this == READY
}
