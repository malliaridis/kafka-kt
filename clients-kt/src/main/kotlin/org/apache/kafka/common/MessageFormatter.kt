 ...
 *
 * Kafka provides a few implementations to display records of internal topics such as
 * __consumer_offsets, __transaction_state and the MirrorMaker2 topics.
 */
interface MessageFormatter : Configurable, Closeable {
