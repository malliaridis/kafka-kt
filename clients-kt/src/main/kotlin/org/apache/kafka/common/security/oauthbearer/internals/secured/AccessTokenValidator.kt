...
/**
 * An instance of `AccessTokenValidator` acts as a function object that, given an access token in
 ...
 * - [RFC 6750, Section 2.1](https://datatracker.ietf.org/doc/html/rfc6750#section-2.1)
 * - [RFC 6750, Section 2.1](https://datatracker.ietf.org/doc/html/draft-ietf-oauth-access-token-jwt)
 *
...
interface AccessTokenValidator {
    ...
    fun validate(accessToken: String): OAuthBearerToken
}
