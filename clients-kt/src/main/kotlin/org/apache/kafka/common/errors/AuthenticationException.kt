 ...
 *  * [UnsupportedSaslMechanismException] if the SASL mechanism requested by the client
 * is not supported on the broker.
 *  * [IllegalSaslStateException] if an unexpected request is received on during SASL
