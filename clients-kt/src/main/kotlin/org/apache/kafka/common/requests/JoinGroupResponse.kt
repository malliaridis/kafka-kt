...
class JoinGroupResponse(
    private val data: JoinGroupResponseData,
    version: Short,
) : AbstractResponse(ApiKeys.JOIN_GROUP) {
    ...
    companion object {
        ...
        fun parse(buffer: ByteBuffer, version: Short): JoinGroupResponse =
            JoinGroupResponse(JoinGroupResponseData(ByteBufferAccessor(buffer), version), version)
    }
}
