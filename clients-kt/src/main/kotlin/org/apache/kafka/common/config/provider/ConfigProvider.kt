...
interface ConfigProvider : Configurable, Closeable {
     ...
     */
    operator fun get(path: String?): ConfigData
     ...
     * @return the configuration data
     */
    operator fun get(path: String?, keys: Set<String>): ConfigData
     ...
     */
    fun subscribe(path: String, keys: Set<String>, callback: ConfigChangeCallback) {
     ...
     */
    fun unsubscribe(path: String, keys: Set<String>, callback: ConfigChangeCallback) {
        throw UnsupportedOperationException()
    }
