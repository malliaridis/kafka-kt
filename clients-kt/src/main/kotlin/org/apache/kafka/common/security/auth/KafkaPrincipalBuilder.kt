 ...
 *
 * Note that the [org.apache.kafka.common.Configurable] and [java.io.Closeable] interfaces are
 * respected if implemented. Additionally, implementations must provide a default no-arg
 * constructor.
 */
interface KafkaPrincipalBuilder {
     ...
     *
     * @param context The authentication context (either [SslAuthenticationContext] or
     * [SaslAuthenticationContext]).
     * @return The built principal which may provide additional enrichment through a subclass of
     * [KafkaPrincipalBuilder].
     */
    fun build(context: AuthenticationContext): KafkaPrincipal
}
