...
class Target internal constructor(
    ...
    private val assignmentStatementGenerator: Function<String, String>
) {

    fun assignmentStatement(rightHandSide: String): String =
        assignmentStatementGenerator.apply(rightHandSide)
    ...
    fun arrayElementTarget(assignmentStatementGenerator: Function<String, String>): Target {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("field"),
    )
    fun field(): FieldSpec = field

    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("sourceVariable"),
    )
    fun sourceVariable(): String = sourceVariable

    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("humanReadableName"),
    )
    fun humanReadableName(): String = humanReadableName
}
