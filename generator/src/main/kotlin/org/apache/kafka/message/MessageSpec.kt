...
class MessageSpec @JsonCreator constructor(
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith("struct"),
    )
    fun struct(): StructSpec = struct
    ...
    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("validVersions"),
    )
    fun validVersions(): Versions = struct.versions
    ...
    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("validVersionsString"),
    )
    @JsonProperty("validVersions")
    fun validVersionsString(): String = struct.versionsString
    ...
    @JsonProperty("fields")
    fun fields(): List<FieldSpec> = struct.fields
    ...
    @JsonProperty("type")
    fun type(): MessageSpecType = type

    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("commonStructs"),
    )
    @JsonProperty("commonStructs")
    fun commonStructs(): List<StructSpec> = commonStructs
    ...
    fun flexibleVersionsString(): String {
        return flexibleVersions.toString()
    }

    @Deprecated(
        message = "User property instead",
        replaceWith = ReplaceWith("listeners"),
    )
    @JsonProperty("listeners")
    fun listeners(): List<RequestListenerType>? = listeners
