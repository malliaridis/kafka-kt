...
@Evolving
enum class TransactionState(private val altName: String) {
    ONGOING("Ongoing"),
    ...
    companion object {
        private val NAME_TO_ENUM = values().associateBy { it.altName }

        fun parse(name: String): TransactionState = NAME_TO_ENUM[name] ?: UNKNOWN
    }
}
