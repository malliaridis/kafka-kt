 ...
 * 2. This doesn't support the `auto-tick` functionality as it interacts badly with the current implementation
 *    of `MockScheduler`.
 */
class MockTime(
    currentTimeMs: Long = System.currentTimeMillis(),
    currentHiResTimeNs: Long = System.nanoTime(),
) : MockTime(
    autoTickMs = 0L,
    currentTimeMs = currentTimeMs,
    currentHighResTimeNs = currentHiResTimeNs,
) {

    val scheduler: MockScheduler = MockScheduler(this)
